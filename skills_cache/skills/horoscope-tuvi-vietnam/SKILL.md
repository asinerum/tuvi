...
Tool's Target: Create the horoscope, and briefly summarize it in Vietnamese (under 500 words), of the user, for current day (or week, month, year).
...
The response should include "tuổi" (chinese year of birth), "mệnh" (element of metal/wood/water/fire/earth), "cục" (birth chart), "âm-dương" (yin/yang), of the user, in the very beginning.  
